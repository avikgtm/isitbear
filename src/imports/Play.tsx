export default function Play() {
  return (
    <div className="bg-white relative size-full" data-name="Play">
      ...
      <p className="absolute font-['Comic_Sans_MS:Regular',sans-serif] leading-[normal] left-1/2 not-italic text-[40px] text-black text-center text-nowrap top-[calc(12.5%+77px)] translate-x-[-50%]">Is it duck?</p>
