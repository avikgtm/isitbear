...
export default function Home() {
  return (
    <div className="bg-white relative size-full" data-name="Home">
      ...
      <p className="absolute font-['Comic_Sans_MS:Regular',sans-serif] leading-[normal] left-1/2 not-italic text-[80px] text-black text-center text-nowrap top-[122px] translate-x-[-50%]">Is it bear?</p>
      ...
      <ol className="absolute block font-['Comic_Sans_MS:Regular',sans-serif] leading-[0] left-[calc(50%-0.5px)] list-decimal list-inside not-italic text-[30px] text-black text-center text-nowrap top-[775px] translate-x-[-50%]" start="1">
        ...
        <li className="ms-[45px]">
          <span className="leading-[normal]">Is it bear? Yes or no</span>
        </li>
      </ol>
      <div className="absolute h-[420px] left-[405px] top-[250px] w-[630px]" data-name="bear">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgBear} />
      </div>
